...
public class Effect_KnockedBack : Effect_HardCrowdControl
{
    ...
    public override void OnStart() {
        ...
        GameController.Instance.WaitAndRunMethod(3f / TargetOfEffect.Tenacity.Current, EndKnockedBack);
    }
    ...
    public override void OnFixedUpdate() {
        if(_stage == 0 && TargetOfEffect.Rigidbody2D.velocity.magnitude < 1) {
            ...
            GameController.Instance.WaitAndRunMethod(0.5f / TargetOfEffect.Tenacity.Current, EndKnockedBack);
        }
    }
