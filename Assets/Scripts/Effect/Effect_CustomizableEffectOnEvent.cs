...
public class Effect_CustomizableEffectOnEvent : Effect
{
    ...
    public Func<DamageInstance, Ability, bool> ConditionCheckForDamageWasDodged;
    public Action<DamageInstance, Ability, Effect_CustomizableEffectOnEvent> ActionOnDamageWasDodged;
    ...
    public Func<DamageInstance, bool> ConditionCheckForTakedown;
    public Action<DamageInstance, Effect_CustomizableEffectOnEvent> ActionOnTakedown;
    public Func<DamageInstance, bool> ConditionCheckForUnitKnockedOut;
    public Action<DamageInstance, Effect_CustomizableEffectOnEvent> ActionOnUnitKnockedOut;
    public Func<DamageInstance, bool> ConditionCheckForHealthBarBroken;
    public Action<DamageInstance, Effect_CustomizableEffectOnEvent> ActionOnHealthBarBroken;
    ...
    public Func<Ability, float, bool, bool> ConditionCheckForAbilityEnergyConsumed;
    public Action<Ability, float, bool, Effect_CustomizableEffectOnEvent> ActionOnAbilityEnergyConsumed;
    ...
    public Func<Item, bool> ConditionCheckForToolUsed;
    public Action<Item, Effect_CustomizableEffectOnEvent> ActionOnToolUsed;
    ...
    public override void OnInvokeAbilityEnergyConsumed(Ability ability, float amount, bool was_full_energy)
    {
        ...
        if (ConditionCheckForAbilityEnergyConsumed != null && ConditionCheckForAbilityEnergyConsumed.Invoke(ability, amount, was_full_energy) && ActionOnAbilityEnergyConsumed != null)
        {
            ActionOnAbilityEnergyConsumed.Invoke(ability, amount, was_full_energy, this);
        }
    }
    ...
    public override void OnInvokeTakedown(DamageInstance damage)
    {
        base.OnInvokeTakedown(damage);
        if (ConditionCheckForTakedown != null && ConditionCheckForTakedown.Invoke(damage) && ActionOnTakedown != null)
        {
            ActionOnTakedown.Invoke(damage, this);
        }
    }

    public override void OnInvokeUnitKnockedOut(DamageInstance damage)
    {
    ...
    public override void OnInvokeHealthBarBroken(DamageInstance damage)
    {
    ...
    public override void OnInvokeToolUsed(Item tool) {
        ...
        if (ConditionCheckForToolUsed != null && ConditionCheckForToolUsed.Invoke(tool) && ActionOnToolUsed != null)
        {
            ActionOnToolUsed.Invoke(tool, this);
        }
    }
}
