...
public class Effect_RollForward : Effect {
    ...
    public override void OnInvokeAfterHitDamageCalculation(Damage damage) {
        ...
        if (Utils.CheckIfPlayerIsFacingUnit(damage.SourceOfDamage.User) && damage.SourceOfDamage.AbilityModifiers.Contains(Constants.AbilityModifier.CounteredByRoll) || (SaveFile.Instance.DifficultyLevel == 0 && damage.SourceOfDamage.IsCounterable))
        {
