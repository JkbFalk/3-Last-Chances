...
public class Effect_CuttingWind : Effect {
    ...
    public Effect_CuttingWind(float extra_stagger, float attack_speed_buff, Constants.DamageType weapon_category, SourceOfEffect source_of_effect) : base(source_of_effect) {
    ...
    public override void OnStart() {
        ...
        if (EffectCategory == Constants.DamageType.Heavy) {
            _visualEffect = MonoBehaviour.Instantiate(Resources.Load("Prefabs/VisualEffect/VisualEffect_SuperCharge_Heavy" + (SourceOfEffect.SourceAbility.UpgradeAUnlocked ? "_MasteryA" : ""))) as GameObject;
        ...
        if (EffectCategory == Constants.DamageType.Light) {
            _visualEffect = MonoBehaviour.Instantiate(Resources.Load("Prefabs/VisualEffect/VisualEffect_SuperCharge_Light" + (SourceOfEffect.SourceAbility.UpgradeAUnlocked ? "_MasteryA" : ""))) as GameObject;
            ...
            _visualEffect.transform.localRotation = Quaternion.Euler(0, 0, -90);
            _visualEffect2 = MonoBehaviour.Instantiate(Resources.Load("Prefabs/VisualEffect/VisualEffect_SuperCharge_Light" + (SourceOfEffect.SourceAbility.UpgradeAUnlocked ? "_MasteryA" : ""))) as GameObject;
            ...
            _visualEffect = MonoBehaviour.Instantiate(Resources.Load("Prefabs/VisualEffect/VisualEffect_SuperCharge_Ranged" + (SourceOfEffect.SourceAbility.UpgradeAUnlocked ? "_MasteryA" : ""))) as GameObject;
