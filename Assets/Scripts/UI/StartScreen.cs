...
public class StartScreen : MonoBehaviour {
    ...
    public void ChangeCombatType()
    {
        ...
        Settings.Instance.DefaultDifficulty = combat_type.value == 0 ? Constants.Difficulty.Story : combat_type.value == 1 ? Constants.Difficulty.Regular : combat_type.value == 2 ? Constants.Difficulty.Challenge : Constants.Difficulty.Ultimate;
    }
