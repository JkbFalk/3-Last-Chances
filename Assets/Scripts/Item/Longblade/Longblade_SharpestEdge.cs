...
public class Longblade_SharpestEdge : Item
{
    ...
    public override List<Effect> GetFirstModifier() {
        return new List<Effect> { 
            ...
            new Effect_ChangeEffectPower(typeof(Effect_Sharp), Effect_ChangeEffectPower.ChangeTypeEnum.AffectDecaySpeed, Effect_ChangeEffectPower.AffectedUnitsTypeEnum.Player, GetFirstModifierEffectValue(false) * 2.5f, new(this)) {EffectTypeName="NoDescription"}
        };
    }
