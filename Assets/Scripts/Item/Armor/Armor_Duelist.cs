...
public class Armor_Duelist : Item
{
    ...
    public override List<Effect> GetFirstModifier() {
        return new List<Effect> { new Effect_GainPartOfSharpAsDR(new(this)), new Effect_ChangeEffectPower(typeof(Effect_Sharp), Effect_ChangeEffectPower.ChangeTypeEnum.AffectAmountAdded, Effect_ChangeEffectPower.AffectedUnitsTypeEnum.Player, GetFirstModifierEffectValue(false) * 0.25f, new(this)) };
    }
