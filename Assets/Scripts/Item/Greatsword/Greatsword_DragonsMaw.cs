...
public class Greatsword_DragonsMaw : Item
{
    ...
    public override List<Effect> GetFirstModifier() {
        return new List<Effect> { new Effect_CustomizableDamageChange(new(this)) {RemainsActiveInOtherStances = true, CustomParam =  GetFirstModifierEffectValue() * 0.16f,EffectTypeName="HeavyDamageAppliesBurn", DescriptionParameters = new List<String> {Utils.GetFormattedFloat(GetFirstModifierEffectValue() * 0.16f, 0)}, ConditionCheckOnDamageDealt = new Func<Damage, Effect_CustomizableDamageChange, bool>((damage, effect) =>
