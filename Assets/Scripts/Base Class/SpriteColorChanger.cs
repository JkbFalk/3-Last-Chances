...
public class SpriteColorChanger : MonoBehaviour, IMaterialModifier
{
    private SpriteRenderer _spriteRenderer;
    public bool IgnoreSpriteParent = false;
    public Color Grey;
    [Range(1.0f, 5.0f)]
    public float GreyBrightness = 0.75f;
    [Range(1.0f, 5.0f)]
    public float GreyDarkness = 0.25f;
    public Color Brown;
    [Range(1.0f, 5.0f)]
    ...
    public void UpdateMaterialProperties() {
        if (_spriteRenderer == null)
        {
            throw new MissingReferenceException($"SpriteColorChanger could not find SpriteRenderer component: {Utils.GetGameObjectPath(gameObject)}");
        }
    ...
    public Material GetModifiedMaterial(Material baseMaterial)
    {
        ...
        if (texture == null)
        {
            throw new MissingReferenceException($"Failed to find texture under directory: Sprites/{TextureName}");
        }
