...
public static class Constants {
    ...
    public const float DEFAULT_STACKING_EFFECT_DECAY_PER_SECOND = 0f;
    public const float INJURY_PERCENTAGE_FROM_PARRY = 0;
    public const float STAGGER_PERCENTAGE_FROM_PARRY = 200;
    public const float INJURY_PERCENTAGE_FROM_RIPOSTE = 150;
    public const float STAGGER_PERCENTAGE_FROM_RIPOSTE = 500;
    public const float INJURY_PERCENTAGE_FROM_PROJECTILE_RIPOSTE = 100;
    public const float STAGGER_PERCENTAGE_FROM_PROJECTILE_RIPOSTE = 400;
    public const float INJURY_PERCENTAGE_FROM_COUNTER = 300;
    public const float STAGGER_PERCENTAGE_FROM_COUNTER = 700;
