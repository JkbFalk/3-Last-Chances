...
public class NPCAbility_ShieldCharge : Ability {
    ...
    public NPCAbility_ShieldCharge(Unit ability_user) : base(ability_user) {
        DamageSources.Add(new DamageSource(10, 200, Constants.DamageType.Heavy) {Knockback = 300, CustomHitSound="Ability/Criminal_Shield_MoveAttack"});
        DamageSources.Add(new DamageSource(10, 50, Constants.DamageType.Heavy, "2+") {Knockback = 300, CustomHitSound="Ability/Criminal_Shield_MoveAttack"});
        DamageSources.Add(new DamageSource(10, 50, Constants.DamageType.Heavy, "ChargeAoE") {Knockback = 300, CustomHitSound="Ability/Criminal_Shield_MoveAttack"});
