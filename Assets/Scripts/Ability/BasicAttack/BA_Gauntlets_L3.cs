...
public class BA_Gauntlets_L3 : BasicAttack {

    public BA_Gauntlets_L3(Unit ability_user) : base(ability_user) {
    ...
    {
        if (PlayerControls.BasicAttackButtonPressCounter > 0.2f)
        {
