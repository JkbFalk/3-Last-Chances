...
public class NPCAbility_RunningAndSlashing : Ability {
    ...
    public NPCAbility_RunningAndSlashing(Unit ability_user) : base(ability_user) {
        ...
        DamageSources.Add(new DamageSource(100, 25, Constants.DamageType.Light) {Knockback = 200});
        DamageSources.Add(new DamageSource(100, 250, Constants.DamageType.Light, "2") {Knockback = 750});
    }
    ...
    public override void CallAbilityEvent1() {
        ...
        User.ApplyForce(direction_vector_towards_target * 300, this);
    }
