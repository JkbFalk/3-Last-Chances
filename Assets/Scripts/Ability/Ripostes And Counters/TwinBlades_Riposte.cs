...
public class TwinBlades_Riposte : Riposte
{

    public TwinBlades_Riposte(Unit ability_user) : base(ability_user) {
        DamageSources.Add(new DamageSource(Constants.INJURY_PERCENTAGE_FROM_RIPOSTE / 2, 0, Constants.DamageType.Light) {KnockbackInMeters = 0.5f});
